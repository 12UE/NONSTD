...
namespace nonstd {
   ...
   template <class _Ty>
   concept _Boolean_testable_impl = __is_convertible_to(_Ty, bool);
   ...
   && same_as<common_reference_t<_Ty1, _Ty2>, common_reference_t<_Ty2, _Ty1>>
       && is_convertible_v<_Ty1, common_reference_t<_Ty1, _Ty2>>
       && is_convertible_v<_Ty2, common_reference_t<_Ty1, _Ty2>>;
   ...
   template <class _Ty1, class _Ty2>
   concept _Weakly_equality_comparable_with =_Half_equality_comparable<_Ty1, _Ty2> && _Half_equality_comparable<_Ty2, _Ty1>;
   ...
   using compare_three_way_result_t =
       decltype(nonstd:: declval<const remove_reference_t<_Ty1>&>() <=> nonstd:: declval<const remove_reference_t<_Ty2>&>());
   ...
   struct compare_three_way {
       ...
       _NODISCARD constexpr auto operator()(_Ty1&& _Left, _Ty2&& _Right) const
           noexcept(noexcept(nonstd:: forward<_Ty1>(_Left) <=> nonstd:: forward<_Ty2>(_Right))) /* strengthened */ {
           return nonstd:: forward<_Ty1>(_Left) <=> nonstd:: forward<_Ty2>(_Right);
       }
   ...
   template <class _Ty1, class _Ty2 = _Ty1>
   using _Synth_three_way_result = decltype(_Synth_three_way{}(nonstd:: declval<_Ty1&>(), nonstd:: declval<_Ty2&>()));
           ...
           _NODISCARD static _CONSTEVAL _Choice_t<_St> _Choose() noexcept {
               if constexpr (!same_as<decay_t<_Ty1>, decay_t<_Ty2>>) {
                   ...
                   return { _St::_Adl, noexcept(static_cast<strong_ordering>(
                       /* ADL */ strong_order(nonstd:: declval<_Ty1&>(), nonstd:: declval<_Ty2&>()))) };
               }
                   ...
                   return { _St::_Three, noexcept(static_cast<strong_ordering>(
                                            compare_three_way{}(nonstd:: declval<_Ty1&>(), nonstd:: declval<_Ty2&>()))) };
               }
               else {
                   return { _St::_None };
               }
   ...
   namespace _Weak_order {
       ...
       // Throughput optimization: attempting to use nonstd:: strong_order will always select ADL strong_order here.
       void strong_order(); // Block unqualified name lookup; see GH-1374.
           ...
           _NODISCARD static _CONSTEVAL _Choice_t<_St> _Choose() noexcept {
               if constexpr (!same_as<decay_t<_Ty1>, decay_t<_Ty2>>) {
                   ...
                   return { _St::_Adl, noexcept(static_cast<weak_ordering>(
                       /* ADL */ weak_order(nonstd:: declval<_Ty1&>(), nonstd:: declval<_Ty2&>()))) };
               }
               else if constexpr (floating_point<decay_t<_Ty1>>) {
                   return { _St::_Floating, true };
               }
                   ...
                   return { _St::_Strong, noexcept(static_cast<weak_ordering>(static_cast<strong_ordering>(
                       /* ADL, throughput optimization */ strong_order(
                           nonstd:: declval<_Ty1&>(), nonstd:: declval<_Ty2&>())))) };
               }
               else {
                   return { _St::_None };
               }
   ...
   namespace _Partial_order {
       ...
       // Throughput optimization: attempting to use nonstd:: weak_order
           ...
           _NODISCARD static _CONSTEVAL _Choice_t<_St> _Choose() noexcept {
               if constexpr (!same_as<decay_t<_Ty1>, decay_t<_Ty2>>) {
                   ...
                   return { _St::_Adl, noexcept(static_cast<partial_ordering>(
                       /* ADL */ partial_order(nonstd:: declval<_Ty1&>(), nonstd:: declval<_Ty2&>()))) };
               }
               else if constexpr (_Can_compare_three_way<_Ty1, _Ty2>) {
                   ...
                   return { _St::_Weak,
                       noexcept(static_cast<partial_ordering>(static_cast<weak_ordering>(
                           /* ADL, throughput optimization */ weak_order(nonstd:: declval<_Ty1&>(), nonstd:: declval<_Ty2&>())))) };
               }
               else if constexpr (_Strong_order::_Has_ADL<_Ty1, _Ty2>) {
   ...
   concept _Can_strong_order = requires(_Ty1 & _Left, _Ty2 & _Right) {
       nonstd:: strong_order(_Left, _Right);
   };
       ...
       private:
           ...
           _NODISCARD static _CONSTEVAL _Choice_t<_St> _Choose() noexcept {
               if constexpr (!same_as<decay_t<_Ty1>, decay_t<_Ty2>>) {
                   ...
                   return { _St::_Strong, noexcept(nonstd:: strong_order(nonstd:: declval<_Ty1&>(), nonstd:: declval<_Ty2&>())) };
               }
               else if constexpr (_Can_fallback_eq_lt<_Ty1, _Ty2>) {
                   return { _St::_Fallback,
                       noexcept(nonstd:: declval<_Ty1&>() == nonstd:: declval<_Ty2&>() ? strong_ordering::equal
                                : nonstd:: declval<_Ty1&>() < nonstd:: declval<_Ty2&>() ? strong_ordering::less
       ...
       public:
           ...
           _NODISCARD constexpr strong_ordering operator()(_Ty1&& _Left, _Ty2&& _Right) const
               ...
               if constexpr (_Strat == _St::_Strong) {
                   return nonstd:: strong_order(_Left, _Right);
               }
   ...
   concept _Can_weak_order = requires(_Ty1 & _Left, _Ty2 & _Right) {
       nonstd:: weak_order(_Left, _Right);
   };
       ...
       private:
           ...
           _NODISCARD static _CONSTEVAL _Choice_t<_St> _Choose() noexcept {
               if constexpr (!same_as<decay_t<_Ty1>, decay_t<_Ty2>>) {
                   ...
                   return { _St::_Weak, noexcept(nonstd:: weak_order(nonstd:: declval<_Ty1&>(), nonstd:: declval<_Ty2&>())) };
               }
               else if constexpr (_Can_fallback_eq_lt<_Ty1, _Ty2>) {
                   return {
                       _St::_Fallback, noexcept(nonstd:: declval<_Ty1&>() == nonstd:: declval<_Ty2&>() ? weak_ordering::equivalent
                                                : nonstd:: declval<_Ty1&>() < nonstd:: declval<_Ty2&>() ? weak_ordering::less
       ...
       public:
           ...
           _NODISCARD constexpr weak_ordering operator()(_Ty1&& _Left, _Ty2&& _Right) const
               ...
               if constexpr (_Strat == _St::_Weak) {
                   return nonstd:: weak_order(_Left, _Right);
               }
               else if constexpr (_Strat == _St::_Fallback) {
   ...
   concept _Can_partial_order = requires(_Ty1 & _Left, _Ty2 & _Right) {
       nonstd:: partial_order(_Left, _Right);
   };
       ...
       private:
           ...
           _NODISCARD static _CONSTEVAL _Choice_t<_St> _Choose() noexcept {
               if constexpr (!same_as<decay_t<_Ty1>, decay_t<_Ty2>>) {
                   ...
                   return { _St::_Partial, noexcept(nonstd:: partial_order(nonstd:: declval<_Ty1&>(), nonstd:: declval<_Ty2&>())) };
               }
               else if constexpr (_Can_fallback_eq_lt_twice<_Ty1, _Ty2>) {
                   return { _St::_Fallback,
                       noexcept(nonstd:: declval<_Ty1&>() == nonstd:: declval<_Ty2&>() ? partial_ordering::equivalent
                                : nonstd:: declval<_Ty1&>() < nonstd:: declval<_Ty2&>() ? partial_ordering::less
                                : nonstd:: declval<_Ty2&>() < nonstd:: declval<_Ty1&>() ? partial_ordering::greater
       ...
       public:
           ...
           _NODISCARD constexpr partial_ordering operator()(_Ty1&& _Left, _Ty2&& _Right) const
               ...
               if constexpr (_Strat == _St::_Partial) {
                   return nonstd:: partial_order(_Left, _Right);
               }
               else if constexpr (_Strat == _St::_Fallback) {
